...
function Register() {
    ...
    function submitData(data){
      ...
      console.log(data)
        axios.post('http://127.0.0.1:8000/v1/add/',data,{
          headers:{
  ...
  return (
    <div>
            <form onSubmit={handleSubmit(submitData)} className="row g-2 fw-bold w-50 mx-auto filter: blur(10px) p-5 bg-dark text-warning">
